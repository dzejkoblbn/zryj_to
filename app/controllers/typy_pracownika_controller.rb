class TypyPracownikaController < ApplicationController
  before_action :set_typy_pracownika, only: [:show, :edit, :update, :destroy]

  # GET /typy_pracownika
  # GET /typy_pracownika.json
  def index
    @typy_pracownika = TypyPracownika.all
  end

  # GET /typy_pracownika/1
  # GET /typy_pracownika/1.json
  def show
  end

  # GET /typy_pracownika/new
  def new
    @typy_pracownika = TypyPracownika.new
  end

  # GET /typy_pracownika/1/edit
  def edit
  end

  # POST /typy_pracownika
  # POST /typy_pracownika.json
  def create
  ...
  # PATCH/PUT /typy_pracownika/1
  # PATCH/PUT /typy_pracownika/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /typy_pracownika/1
  # DELETE /typy_pracownika/1.json
  def destroy
    @typy_pracownika.destroy
    respond_to do |format|
      format.html { redirect_to typy_pracownika_index_url, notice: 'Typy pracownika was successfully destroyed.' }
  ...
  private
    ...
    def typy_pracownika_params
      params.require(:typy_pracownika).permit(:index)
    end
end
