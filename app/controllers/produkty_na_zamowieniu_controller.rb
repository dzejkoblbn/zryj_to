class ProduktyNaZamowieniuController < ApplicationController
  before_action :set_produkty_na_zamowieniu, only: [:show, :edit, :update, :destroy]

  # GET /produkty_na_zamowieniu
  # GET /produkty_na_zamowieniu.json
  def index
    @produkty_na_zamowieniu = ProduktyNaZamowieniu.all
  end

  # GET /produkty_na_zamowieniu/1
  # GET /produkty_na_zamowieniu/1.json
  def show
  end

  # GET /produkty_na_zamowieniu/new
  def new
    @produkty_na_zamowieniu = ProduktyNaZamowieniu.new
  end

  # GET /produkty_na_zamowieniu/1/edit
  def edit
  end

  # POST /produkty_na_zamowieniu
  # POST /produkty_na_zamowieniu.json
  def create
  ...
  # PATCH/PUT /produkty_na_zamowieniu/1
  # PATCH/PUT /produkty_na_zamowieniu/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /produkty_na_zamowieniu/1
  # DELETE /produkty_na_zamowieniu/1.json
  def destroy
    @produkty_na_zamowieniu.destroy
    respond_to do |format|
      format.html { redirect_to produkty_na_zamowieniu_index_url, notice: 'Produkty na zamowieniu was successfully destroyed.' }
  ...
  private
    ...
    def produkty_na_zamowieniu_params
      params.require(:produkty_na_zamowieniu).permit(:index)
    end
end
